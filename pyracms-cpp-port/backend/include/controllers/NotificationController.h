...
class NotificationController
  ...
  public:
    ...
    ADD_METHOD_TO(NotificationController::markRead,
                  "/api/notifications/{id}/read", drogon::Put,
                  "pyracms::JwtAuthFilter");
    ADD_METHOD_TO(NotificationController::markAllRead,
                  "/api/notifications/read-all", drogon::Put,
                  "pyracms::JwtAuthFilter");
    ADD_METHOD_TO(NotificationController::deleteNotification,
                  "/api/notifications/{id}", drogon::Delete,
                  "pyracms::JwtAuthFilter");
    METHOD_LIST_END
    ...
    void
    markRead(const drogon::HttpRequestPtr &req,
             std::function<void(const drogon::HttpResponsePtr &)> &&callback,
             int id);
