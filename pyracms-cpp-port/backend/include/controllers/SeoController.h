...
class SeoController : public drogon::HttpController<SeoController> {
  public:
    ...
    ADD_METHOD_TO(SeoController::articleJsonLd, "/api/articles/{name}/jsonld",
                  drogon::Get);
    ADD_METHOD_TO(SeoController::articleOpenGraph,
                  "/api/articles/{name}/opengraph", drogon::Get);
    METHOD_LIST_END

    void
    sitemap(const drogon::HttpRequestPtr &req,
            std::function<void(const drogon::HttpResponsePtr &)> &&callback);

    void
    rssFeed(const drogon::HttpRequestPtr &req,
            std::function<void(const drogon::HttpResponsePtr &)> &&callback);

    void
    atomFeed(const drogon::HttpRequestPtr &req,
             std::function<void(const drogon::HttpResponsePtr &)> &&callback);
