...
class SettingsController : public drogon::HttpController<SettingsController> {
  public:
    ...
    ADD_METHOD_TO(SettingsController::getByName, "/api/settings/{name}",
                  drogon::Get);
    ADD_METHOD_TO(SettingsController::createOrUpdate, "/api/settings/{name}",
                  drogon::Put, "pyracms::JwtAuthFilter",
                  "pyracms::AdminFilter");
    ADD_METHOD_TO(SettingsController::remove, "/api/settings/{name}",
    ...
    void
    getByName(const drogon::HttpRequestPtr &req,
              std::function<void(const drogon::HttpResponsePtr &)> &&callback,
