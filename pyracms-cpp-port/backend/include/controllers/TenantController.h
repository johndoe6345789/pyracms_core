...
class TenantController : public drogon::HttpController<TenantController> {
  public:
    ...
    ADD_METHOD_TO(TenantController::getBySlug, "/api/tenants/{slug}",
                  drogon::Get);
    ADD_METHOD_TO(TenantController::create, "/api/tenants", drogon::Post,
                  "pyracms::JwtAuthFilter", "pyracms::RateLimitFilter");
    ADD_METHOD_TO(TenantController::remove, "/api/tenants/{id}", drogon::Delete,
    ...
    void
    getBySlug(const drogon::HttpRequestPtr &req,
              std::function<void(const drogon::HttpResponsePtr &)> &&callback,
