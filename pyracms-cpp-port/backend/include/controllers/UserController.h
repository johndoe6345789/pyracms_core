...
class UserController : public drogon::HttpController<UserController> {
  public:
    ...
    ADD_METHOD_TO(UserController::getById, "/api/users/{id}", drogon::Get,
                  "pyracms::JwtAuthFilter");
    ADD_METHOD_TO(UserController::update, "/api/users/{id}", drogon::Put,
                  "pyracms::JwtAuthFilter");
    ADD_METHOD_TO(UserController::changePassword, "/api/users/{id}/password",
                  drogon::Put, "pyracms::JwtAuthFilter");
    ADD_METHOD_TO(UserController::setRole, "/api/users/{id}/role", drogon::Put,
                  "pyracms::JwtAuthFilter");
    ...
    void
    getById(const drogon::HttpRequestPtr &req,
            std::function<void(const drogon::HttpResponsePtr &)> &&callback,
            int id);
