...
test.describe('Navigation edge cases', () => {
  test(
    ...
    async ({ page }) => {
      ...
      await expect(page.getByTestId('auth-prompt-card')).not.toBeVisible()
    },
  )
  ...
  test('create-site page has correct heading', async ({ page }) => {
  ...
  test('create-site page main region has accessible label', async ({
    page,
  }) => {
    await page.goto('/create-site')
    await expect(
  ...
  test('auth-prompt region has accessible label', async ({ page }) => {
    await page.goto('/create-site')
    await expect(
