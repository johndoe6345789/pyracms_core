...
test.describe('Portal — /', () => {
  test('page renders with "Welcome to PyraCMS" heading', async ({ page }) => {
    await page.goto('/')
  ...
  test('portal-page data-testid is present', async ({ page }) => {
    await page.goto('/')

    await expect(page.getByTestId('portal-page')).toBeVisible()
  })

  test('create-site-button is visible on the portal', async ({ page }) => {
    await page.goto('/')

    await expect(page.getByTestId('create-site-button')).toBeVisible()
  })
  ...
  test('portal main region has an accessible label', async ({ page }) => {
    await page.goto('/')
