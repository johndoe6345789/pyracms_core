...
test.describe('Register — /auth/register', () => {
  ...
  test('all 6 input fields are visible', async ({ page }) => {
    await page.goto('/auth/register')
  ...
  test('register-submit button is visible', async ({ page }) => {
    await page.goto('/auth/register')
  ...
  test(
    'password-strength bar appears after typing in ' + 'the password field',
    async ({ page }) => {
      await page.goto('/auth/register')
