...
test.describe('Search — /search', () => {
  test('results list or empty-state is shown after search', async ({
    page,
  }) => {
  ...
  test('pre-populated ?q= param fills the search input', async ({ page }) => {
  ...
  test('empty query shows empty-state or placeholder text', async ({
    page,
  }) => {
