...
test.describe('Article edit — /site/demo/articles/hello-world/edit', () => {
  ...
  test('page container is rendered', async ({ page }) => {
    ...
    await expect(page.getByTestId('edit-article-page')).toBeVisible({
      timeout: 8_000,
    })
  })

  test('"Edit Article" heading is visible', async ({ page }) => {
    await page.goto(`${BASE}/articles/hello-world/edit`)
    await expect(
  ...
  test('"Back to Article" button links back', async ({ page }) => {
    await page.goto(`${BASE}/articles/hello-world/edit`)
  ...
  test('article editor form is rendered', async ({ page }) => {
    await page.goto(`${BASE}/articles/hello-world/edit`)
    await expect(page.getByTestId('article-editor-form')).toBeVisible({
      timeout: 8_000,
    })
  })
})
