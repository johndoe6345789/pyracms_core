...
describe('RegisterFields – aria-labels', () => {
  ...
  it('email input has aria-label "Email address"', () => {
    setup()
    expect(screen.getByTestId('register-email-input')).toHaveAttribute(
      'aria-label',
      'Email address',
    )
  })
  ...
  it('password input has aria-label "Password"', () => {
    setup()
    expect(screen.getByTestId('register-password-input')).toHaveAttribute(
      'aria-label',
      'Password',
    )
  })
  ...
  it('first-name input has aria-label "First name"', () => {
    setup()
    expect(screen.getByTestId('register-firstname-input')).toHaveAttribute(
      'aria-label',
      'First name',
    )
  })
  ...
  it('last-name input has aria-label "Last name"', () => {
    setup()
    expect(screen.getByTestId('register-lastname-input')).toHaveAttribute(
      'aria-label',
      'Last name',
    )
  })
