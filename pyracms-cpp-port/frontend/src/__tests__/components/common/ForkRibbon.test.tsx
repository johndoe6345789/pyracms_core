...
describe('ForkRibbon', () => {
  ...
  it('has an inline variant and honours a repo override', () => {
    ...
    expect(screen.getByTestId('fork-inline')).toHaveAttribute(
      'href',
...
describe('SiteFooter', () => {
  it('links launcher, releases, repo, docs and license', () => {
    ...
    expect(screen.getByTestId('footer-download')).toHaveAttribute(
      'href',
      '/site/x/download',
    )
...
describe('launcher links', () => {
  it('banner and hero button point at the download page', () => {
    render(
      <>
        <GetLauncherLink href="/site/x/download" />
        <HeroLauncherButton />
      </>,
    )
    ...
    expect(screen.getByTestId('hero-download-button')).toHaveAttribute(
      'href',
      '/download',
    )
  })
