...
import { useUserProfile, mapProfile } from '@/components/users/useUserProfile'
...
describe('useUserProfile', () => {
  it('merges the list row, full record and reputation', async () => {
    routes({
      '/api/users?username=u': [
        { id: 1, username: 'u', createdAt: '2024-01-02T00:00:00' },
      ],
  ...
  it('mapProfile ignores wrongly typed fields', () => {
    expect(
      mapProfile({ id: 'a', username: 3 }, {}, { total: 'x' }),
