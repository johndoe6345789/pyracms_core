...
import {
  ...
  ListItemText, Chip, Pagination, Grid,
} from '@mui/material'
import {
...
import SearchAutocomplete from
  '@/components/common/SearchAutocomplete'
import FacetSidebar from
  '@/components/search/FacetSidebar'
...
function highlightMatch(
  ...
  // DOMPurify sanitizes output to prevent XSS
...
export default function SearchPage() {
  ...
  useEffect(() => {
    if (initialQuery) {
      performSearch(
        initialQuery, activeType, page,
      )
    }
  }, [
    initialQuery, activeType,
    page, performSearch,
  ])
