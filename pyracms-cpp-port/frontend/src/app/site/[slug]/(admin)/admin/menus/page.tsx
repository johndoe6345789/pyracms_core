  ...
  return (
    <Box data-testid="admin-menus-page">
      ...
      <Typography
        ...
        sx={{ mb: 4 }}
      >
        Manage navigation menus and menu
        items.
      </Typography>
      <MenuGroupSelect
        ...
        onGroupChange={
          editor.handleGroupChange
        }
        onNewGroup={
          editor.handleOpenGroupDialog
        }
      />
      <Card
        variant="outlined"
        ...
        <CardContent>
          ...
          <Box sx={{
            ...
            >
              ...
              <Select
                value={
                  editor.newPermissions
                }
                label="Permissions"
                onChange={(e) =>
                  editor.setNewPermissions(
                    e.target.value,
                  )
                }
                data-testid={
      ...
      <MenuItemTable
        ...
        onStartEdit={
          editor.handleStartEdit
        }
        onSaveEdit={
          editor.handleSaveEdit
        }
        onCancelEdit={
