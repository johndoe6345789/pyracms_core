...
export default function TenantAdminDashboardPage() {
  ...
  const QUICK_LINKS = [
    ...
    },
    {
      ...
      href: `/site/${slug}/admin/features`,
    },
    {
      label: 'Menus',
      description: 'Edit navigation menus',
      icon: <MenuBookOutlined />,
      href: `/site/${slug}/admin/menus`,
    },
    {
      label: 'ACL',
      description: 'Access control rules',
      icon: <SecurityOutlined />,
      href: `/site/${slug}/admin/acl`,
    },
    {
      label: 'Files',
      description: 'Manage uploaded files',
      icon: <FolderOutlined />,
      href: `/site/${slug}/admin/files`,
    },
    {
      label: 'Backup',
      description: 'Export and import data',
      icon: <BackupOutlined />,
      href: `/site/${slug}/admin/backup`,
    },
  ]
