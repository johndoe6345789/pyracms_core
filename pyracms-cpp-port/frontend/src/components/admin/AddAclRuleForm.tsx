...
export default function AddAclRuleForm(p: AddAclRuleFormProps) {
  return (
    <Card
      variant="outlined"
    ...
    >
      <CardContent>
        ...
        >
          <AclActionSelect value={p.newAction} onChange={p.onActionChange} />
          <TextField
            label="Principal"
            size="small"
            value={p.newPrincipal}
            onChange={(e) => p.onPrincipalChange(e.target.value)}
          ...
          <TextField
            ...
            onChange={(e) => p.onPermissionChange(e.target.value)}
          ...
          <Button
            ...
            onClick={p.onAdd}
            disabled={!p.newPrincipal.trim() || !p.newPermission.trim()}
