  ...
  return (
    <Box sx={{ mb: 3 }} data-testid="article-owner-actions">
      ...
      <Dialog open={confirm} onClose={() => setConfirm(false)}
        ...
        <DialogContent>
          <DialogContentText>
            Delete &quot;{p.article.title}&quot; and all its revisions?
        ...
        <DialogActions>
          ...
          <Button color="error" variant="contained"
            onClick={() => { setConfirm(false); a.remove() }}
