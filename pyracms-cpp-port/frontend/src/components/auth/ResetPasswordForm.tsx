  ...
  return (
    <Box component="form" onSubmit={s.submit} data-testid="reset-form">
      ...
      {s.done ? (
        ...
        <>
          <PasswordField label="New password" value={s.password}
            onChange={s.setPassword} data-testid="reset-password" />
          <PasswordField label="Confirm password" value={s.confirm}
            onChange={s.setConfirm} data-testid="reset-confirm" />
          <Button fullWidth type="submit" variant="contained" size="large"
            disabled={s.busy} sx={{ mt: 2 }} data-testid="reset-submit">
