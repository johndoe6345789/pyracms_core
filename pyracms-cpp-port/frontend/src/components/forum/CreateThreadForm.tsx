...
export function CreateThreadForm({ slug, title, setTitle, description, setDescription, content, setContent }: CreateThreadFormProps) {
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      <Box sx={{ display: 'flex', gap: 2 }}>
        <Button variant="contained" endIcon={<SendOutlined />} size="large">Create Thread</Button>
