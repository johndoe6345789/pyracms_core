...
import {
  FavoriteBorderOutlined, FavoriteOutlined, EditOutlined,
...
export default function GameDetailView(p: Props) {
  ...
  return (
    <Box>
      <GameArt name={d.name} label={d.displayName}
        image={d.screenshots[0]?.src} height={220} size={96} />
      ...
      <GameActions key={d.name} slug={p.slug} name={d.name}
        revisions={d.revisions} binaries={d.binaries}
        installedVersion={p.installedVersion}
        onInstalled={p.onInstalled} onUninstall={p.onUninstall} />
