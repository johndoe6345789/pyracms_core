  ...
  return (
    <Box component="footer" data-testid="site-footer"
      ...
      <Container maxWidth="lg" sx={{ display: 'flex', flexWrap: 'wrap',
        ...
        <Box component="nav" aria-label="Footer" sx={{ display: 'flex',
          flexWrap: 'wrap', gap: 2, alignItems: 'center' }}>
          <MuiLink component={Link} href={downloadHref} sx={linkSx}
            data-testid="footer-download">Download launcher</MuiLink>
          <MuiLink href={releasesUrl()} {...ext} sx={linkSx}>Releases</MuiLink>
          <MuiLink href={repoUrl()} {...ext} sx={linkSx}>GitHub</MuiLink>
          <MuiLink href={docsUrl()} {...ext} sx={linkSx}>Docs</MuiLink>
          <MuiLink href={licenseUrl()} {...ext} sx={linkSx}>License</MuiLink>
